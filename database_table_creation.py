...
DEFAULT_INSIGHT_TYPES = [
    {
        ...
        "report_ids": ["pi-burndown", "pi-metrics-summary", "dependency-heatmap"],
        "active": True,
        "pi_insight": True,
        "team_insight": False,
        "group_insight": True,
    ...
    },
    {
        ...
        "insight_categories": ["Sprint Events"],
        "report_ids": ["active-sprint-summary", "team-sprint-burndown"],
        "active": True,
        "pi_insight": False,
        "team_insight": False,
        "group_insight": True,
    ...
    try:
        with engine.connect() as conn:
            ...
            VALUES 
                ...
                ('backend_epic_max_children_threshold', '25', 'integer', 'Validation & Reporting', 'Maximum children threshold for epic health validation'),
