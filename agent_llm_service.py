...
class JobType(str, Enum):
    ...
    TEAM_RETROSPECTIVE_PREPARATION = "Team Retrospective Preparation"
...
class AgentLLMProcessRequest(BaseModel):
    ...
    job_type: JobType = Field(..., description="Type of job: Daily Agent, Sprint Goal, PI Sync, Team PI Insight, or Team Retrospective Preparation")
