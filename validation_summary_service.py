...
async def get_validation_summary(
    ...
    dragged_sprints_threshold: int = Query(DRAGGED_SPRINTS_THRESHOLD, ge=1, description="Sprints threshold for dragged issues"),
    epic_max_children_threshold: int = Query(EPIC_MAX_CHILDREN_THRESHOLD, ge=1, description="Max children threshold for epics"),
